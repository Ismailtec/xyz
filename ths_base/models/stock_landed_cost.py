...
class StockLandedCost(models.Model):
    ...
    def _onchange_purchase_order_id(self):
        ...
        if self.purchase_order_id:
            ...
            self.vendor_bill_id = False
            self.picking_ids = [(5, 0, 0)]
        # Need to return domain update here if not using computed fields
        # Since we ARE using computed fields, just return empty dict
        return {}
            ...
            if self.vendor_bill_id:
                ...
                if derived_po:
                    ...
                    try:
                        ...
                        _logger.error(
                            f"Failed to evaluate picking domain string: {picking_domain_str}");
    ...
    def action_view_original_lc(self):
        ...
        action['target'] = 'current'  # Open in same window
        return action
