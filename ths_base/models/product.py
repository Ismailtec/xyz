...
class ProductTemplate(models.Model):
    ...
    ths_product_brand = fields.Many2one(
        'product.brand',
    ...
    def _compute_category_domain(self):
        ...
        for record in self:
            ...
            if record.type == 'service':
                ...
                # Assumes 'ths_product_type_filter' field exists on product.category model
                domain = ['|', ('ths_product_type_filter', '=', 'service'), ('ths_product_type_filter', '=', 'all')]
                ...
                domain = ['|', ('ths_product_type_filter', '=', 'product'), ('ths_product_type_filter', '=', 'all')]
                _logger.debug(
    ...
    def _onchange_type_clear_category(self):
        ...
        if self.categ_id and hasattr(self.categ_id,
                                     'ths_product_type_filter') and self.categ_id.ths_product_type_filter != 'all':
            current_categ_filter = self.categ_id.ths_product_type_filter
...
class ProductSupplierinfo(models.Model):
    ...
    # Optional: If you want to make sequence less important visually,
    # you might consider hiding it or deprioritizing it in the view later.
    # But keeping it in _order ensures stable sorting if prices are identical.
