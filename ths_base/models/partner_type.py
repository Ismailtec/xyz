...
class ThsPartnerType(models.Model):
    ...
    Can be hierarchical.
    """
    # Model name uses prefix for custom model
    ...
    # Flag: Is this type typically a company/organization?
    ...
    # Flag: Is this type typically an individual/person?
    ...
    #         raise ValidationError(_('Error! You cannot create recursive partner types.'))
