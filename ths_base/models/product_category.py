...
class ProductCategory(models.Model):
    ...
    ths_product_type_filter = fields.Selection(
        [
    ...
    def action_view_products(self):
        ...
        if category_to_filter_by and category_to_filter_by.ths_product_type_filter != 'all':
            filter_setting = category_to_filter_by.ths_product_type_filter
