...
class ThsTreatmentRoom(models.Model):
    ...
    medical_staff_ids = fields.Many2many(
        'hr.employee',
        'ths_treatment_room_staff_rel',
        'room_id', 'employee_id',
        string='Allowed Medical Staff',
        domain="[('ths_is_medical', '=', True), ('active', '=', True), ('department_id', '=', department_id)]",
    ...
    def _prepare_resource_resource_vals(self):
        ...
        return {
            ...
            'active': True,
            'ths_treatment_room_id': self.id,  # Link back to this room
        }
    ...
    def _create_or_activate_resources_for_appointment(self):
        ...
        if not app_resource:
            ...
            if app_resource.ths_resource_category != 'location':
                vals_to_update_ar['ths_resource_category'] = 'location'
