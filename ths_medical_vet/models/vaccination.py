	...
	def create(self, vals_list):
		...
		for vaccination in vaccinations:
			if not vaccination.encounter_id and vaccination.owner_id:
				practitioner_resource = vaccination.veterinarian_id.ths_appointment_resource_id \
					if vaccination.veterinarian_id and \
					   hasattr(vaccination.veterinarian_id, 'ths_appointment_resource_id') \
					else False
				...
				encounter = self.env['ths.medical.base.encounter']._find_or_create_daily_encounter(
					...
					practitioner_id=practitioner_resource,
					room_id=False
				)
