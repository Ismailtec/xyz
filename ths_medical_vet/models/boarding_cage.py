...
class VetBoardingCage(models.Model):
    ...
    allowed_species = fields.Char(
        string='Allowed Species',
        help="Specify species allowed, e.g., 'Dogs (Small)', 'Cats', 'Any'. For simple text filtering."
        # Consider converting to Many2many vet.species later if needed
    )
