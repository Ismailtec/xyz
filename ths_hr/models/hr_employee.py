...
class HrEmployee(models.Model):
    ...
    def _sync_work_partner_details(self):
        ...
        # --- 1. Determine Target Partner Type ---
        target_partner_type_xmlid = 'ths_hr.partner_type_employee'
        if self.employee_type == 'part_time':
            target_partner_type_xmlid = 'ths_hr.partner_type_part_time_employee'
        elif self.employee_type == 'external_employee':
